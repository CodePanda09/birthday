  ...
  return (
    <header className="w-full">
      <motion.div 
        ...
        className="backdrop-blur-md bg-gradient-to-r from-black/20 via-black/30 to-black/20 min-h-[120px] border-b border-white/10 shadow-lg"
      >
        <div className="max-w-[2000px] mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            >
              <motion.div 
                className="flex items-center space-x-3 bg-gradient-to-r from-purple-400/10 to-pink-400/10 px-6 py-3 
